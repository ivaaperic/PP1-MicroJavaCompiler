...
public class GlobalVarDeclMoreIv extends GlobVarDeclMore {

    private GlobIdent GlobIdent;
    private SquareBrackets SquareBrackets;

    public GlobalVarDeclMoreIv (GlobIdent GlobIdent, SquareBrackets SquareBrackets) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("GlobalVarDeclMoreIv(\n");
